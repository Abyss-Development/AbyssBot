...
import net.abyssdev.abyssbot.command.commands.CreateProductCommand;
import net.abyssdev.abyssbot.command.commands.PaymentCommand;
...
public final class AbyssBot {
    ...
    public static void main(final String[] args) {
        ...
        AbyssBot.commandMap.registerCommand(new VerifyPanelCommand(), new ContractorCommand(), new PaymentCommand(), new CreateProductCommand());
