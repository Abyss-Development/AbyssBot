...
public final class ContractorCommand extends Command {
    ...
    public void onCommand(Member member, OptionMapping[] args, SlashCommandEvent event) {
        ...
        event.getGuild().createTextChannel(user.getName() + "-" + role, event.getGuild().getCategoryById(951919951885795378L)).queue(textChannel -> {
            ...
            textChannel.sendMessage(new EmbedBuilder()
                    ...
                    .setDescription("Welcome to your contractor channel, " + user.getName()
                            ...
                            "Firstly so we can communicate without issues, and secondly so everyone is filled in." +
